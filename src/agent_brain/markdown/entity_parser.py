...
from agent_brain.markdown.plugins import observation_plugin, relation_plugin
...
from agent_brain.utils import parse_tags
...
class EntityParser:
    ...
    async def parse_markdown_content(
        ...
        # See issue #452
        from agent_brain.file_utils import strip_bom
        ...
        # downstream.  See agent-brain-cloud#376.
