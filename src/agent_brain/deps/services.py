"""Service dependency injection for agent-brain.
...
from agent_brain.deps.config import AppConfigDep
from agent_brain.deps.projects import (
    ProjectConfigDep,
    ProjectConfigV2Dep,
    ProjectConfigV2ExternalDep,
    ProjectRepositoryDep,
)
from agent_brain.deps.repositories import (
    EntityRepositoryDep,
...
from agent_brain.services import EntityService, ProjectService
...
from agent_brain.sync import SyncService
...
class LocalTaskScheduler:
    ...
    In test mode (AGENT_BRAIN_ENV=test), tasks run as no-ops to avoid
    ...
    def __init__(
        ...
        self._test_mode = (
            test_mode if test_mode is not None else os.environ.get("AGENT_BRAIN_ENV") == "test"
        )
    ...
    def schedule(self, task_name: str, **payload: Any) -> None:
        ...
        # Trigger: running inside pytest (AGENT_BRAIN_ENV=test)
