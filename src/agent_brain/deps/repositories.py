"""Repository dependency injection for agent-brain.
...
from agent_brain.deps.db import SessionMakerDep
...
from agent_brain.repository.search_repository import SearchRepository, create_search_repository
