...
from agent_brain.config import AgentBrainConfig, WATCH_STATUS_JSON
from agent_brain.ignore_utils import load_gitignore_patterns, should_ignore_path
...
class WatchService:
    def __init__(
        ...
        self.status_path = Path.home() / ".agent-brain" / WATCH_STATUS_JSON
