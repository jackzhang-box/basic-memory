"""Shared initialization service for Agent Brain.
...
async def initialize_database(app_config: AgentBrainConfig) -> None:
    """Initialize database with migrations handled automatically by get_or_create_db.

    Args:
        app_config: The Agent Brain project configuration
...
async def reconcile_projects_with_config(app_config: AgentBrainConfig):
    ...
    Args:
        app_config: The Agent Brain application configuration
    """
...
async def initialize_file_sync(
    ...
    # delay import
    from agent_brain.sync import WatchService
    ...
    async def sync_project_background(project: Project):
        ...
        from agent_brain.sync.sync_service import get_sync_service
...
async def initialize_app(
    ...
    """Initialize the Agent Brain application.
...
def ensure_initialization(app_config: AgentBrainConfig) -> None:
