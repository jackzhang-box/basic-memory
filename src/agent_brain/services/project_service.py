"""Project management service for Agent Brain."""
...
class ProjectService:
    """Service for managing Agent Brain projects."""
    ...
    def current_project(self) -> Optional[str]:
        ...
        """
        return os.environ.get("AGENT_BRAIN_PROJECT", self.config_manager.default_project)
    ...
    async def add_project(self, name: str, path: str, set_default: bool = False) -> None:
        ...
        if project_root:
            ...
            if not resolved_path.startswith(base_path.resolve().as_posix()):  # pragma: no cover
                raise ValueError(
                    f"AGENT_BRAIN_PROJECT_ROOT is set to {project_root}. "
    ...
    async def get_project_info(self, project_name: Optional[str] = None) -> ProjectInfoResponse:
        """Get comprehensive information about the specified Agent Brain project.
        ...
        try:
            ...
            return EmbeddingStatus(
                ...
                reindex_reason=(
                    ...
                    "environment — install/update agent-brain, then run: bm reindex --embeddings"
                ),
            )
    ...
    def get_system_status(self) -> SystemStatus:
        ...
        watch_status = None
        watch_status_path = Path.home() / ".agent-brain" / WATCH_STATUS_JSON
        ...
        return SystemStatus(
            version=agent_brain.__version__,
