...
from agent_brain.models import Entity, Project
...
from agent_brain.schemas.search import SearchQuery, SearchItemType
...
class LinkResolver:
    ...
    def __init__(self, entity_repository: EntityRepository, search_service: SearchService):
        ...
        self._app_config: AgentBrainConfig = ConfigManager().config
    ...
    async def _resolve_in_project(
        ...
        *,
        ...
        # --- Path Resolution ---
        # Note: All paths in Agent Brain are stored as POSIX strings (forward slashes)
