...
from agent_brain.markdown import EntityMarkdown
from agent_brain.markdown.entity_parser import (
    EntityParser,
    _coerce_to_string,
    normalize_frontmatter_metadata,
)
from agent_brain.markdown.utils import entity_model_from_markdown, schema_to_markdown
from agent_brain.models import Entity as EntityModel
from agent_brain.models import Observation, Relation
from agent_brain.models.knowledge import Entity
from agent_brain.repository import ObservationRepository, RelationRepository
...
from agent_brain.schemas.base import Permalink
...
from agent_brain.services import BaseService, FileService
from agent_brain.services.exceptions import (
...
from agent_brain.utils import build_canonical_permalink
...
class EntityService(BaseService[EntityModel]):
    ...
    def __init__(
        ...
        app_config: Optional[AgentBrainConfig] = None,
    ):
    ...
    async def detect_file_path_conflicts(
        ...
        from agent_brain.utils import detect_potential_file_conflicts
    ...
    def _build_frontmatter_markdown(
        ...
        from agent_brain.markdown.schemas import EntityFrontmatter
