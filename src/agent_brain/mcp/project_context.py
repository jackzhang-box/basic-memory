"""Project context utilities for Agent Brain MCP server.
...
from agent_brain.project_resolver import ProjectResolver
from agent_brain.schemas.project_info import ProjectItem, ProjectList
from agent_brain.schemas.v2 import ProjectResolveResponse
from agent_brain.schemas.memory import memory_url_path
from agent_brain.utils import generate_permalink, normalize_project_reference
...
async def resolve_project_parameter(
    ...
    Resolution order:
    1. ENV_CONSTRAINT: AGENT_BRAIN_MCP_PROJECT env var (highest priority)
...
async def get_active_project(
    ...
    with telemetry.scope(
        ...
        # Deferred import to avoid circular dependency with tools
        from agent_brain.mcp.tools.utils import call_post
...
def detect_project_from_url_prefix(identifier: str, config: AgentBrainConfig) -> Optional[str]:
    ...
    Args:
        ...
        config: Current AgentBrainConfig with project entries.
