...
@mcp.resource(
    ...
    description="Give an AI assistant guidance on how to use Agent Brain tools effectively",
)
def ai_assistant_guide() -> str:
    """Return a concise guide on Agent Brain tools and how to use them.
    ...
    Returns:
        A focused guide on Agent Brain usage.
    """
