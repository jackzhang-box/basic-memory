"""Canvas creation tool for Agent Brain MCP server.
...
from agent_brain.utils import coerce_list
from agent_brain.mcp.server import mcp
from agent_brain.mcp.tools.utils import call_put, call_post, resolve_entity_id
