"""Read note tool for Agent Brain MCP server."""
...
@mcp.tool(
    ...
    # meta={"ui/resourceUri": "ui://agent-brain/note-preview"},
    ...
    with telemetry.operation(
        ...
        async with get_project_client(project, context=context) as (client, active_project):
            with telemetry.contextualize(
                ...
                from agent_brain.mcp.clients import KnowledgeClient, ResourceClient
