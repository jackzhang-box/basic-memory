"""ChatGPT-compatible MCP tools for Agent Brain.

These adapters expose Agent Brain's search/fetch functionality using the exact
...
from agent_brain.schemas.search import SearchResponse, SearchResult
