"""Recent activity tool for Agent Brain MCP server."""
...
from agent_brain.schemas.base import TimeFrame
from agent_brain.schemas.memory import (
    GraphContext,
    ProjectActivity,
    ActivityStats,
)
from agent_brain.schemas.project_info import ProjectList, ProjectItem
...
async def recent_activity(
    ...
    if resolved_project is None:
        ...
        async with get_project_client(resolved_project, context=context) as (
            client,
            active_project,
        ):
