"""Write note tool for Agent Brain MCP server."""
...
from agent_brain.mcp.project_context import get_project_client, add_project_metadata
from agent_brain.mcp.server import mcp
from fastmcp import Context
from agent_brain.schemas.base import Entity
from agent_brain.utils import coerce_dict, parse_tags, validate_project_path
    ...
    with telemetry.operation(
        ...
        async with get_project_client(project, context=context) as (client, active_project):
            with telemetry.contextualize(
                ...
                from agent_brain.mcp.clients import KnowledgeClient
