"""Move note tool for Agent Brain MCP server."""
...
from agent_brain.utils import validate_project_path
...
```
# Check if note exists in Agent Brain
read_note("{identifier}")
...
```"""
        ...
        if "." not in destination_path or not destination_path.split(".")[-1]:
            ...
            return dedent(f"""
                ...
                All examples in Agent Brain expect file extensions to be explicitly provided.
                """).strip()
