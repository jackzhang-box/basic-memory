"""Claude projects import service for Agent Brain."""
...
from agent_brain.schemas.importer import ProjectImportResult
from agent_brain.importers.utils import clean_filename
...
class ClaudeProjectsImporter(Importer[ProjectImportResult]):
    ...
    def _format_project_markdown(
        ...
        """Format a project document as a Agent Brain entity.
    ...
    def _format_prompt_markdown(
        ...
        """Format project prompt template as a Agent Brain entity.
