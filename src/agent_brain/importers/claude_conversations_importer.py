"""Claude conversations import service for Agent Brain."""
...
from agent_brain.schemas.importer import ChatImportResult
from agent_brain.importers.utils import clean_filename, format_timestamp
...
class ClaudeConversationsImporter(Importer[ChatImportResult]):
    ...
    def _format_chat_content(
        ...
        """Convert chat messages to Agent Brain entity format.
