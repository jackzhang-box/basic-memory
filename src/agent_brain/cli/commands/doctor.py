...
from agent_brain.mcp.clients import KnowledgeClient, ProjectClient, SearchClient
from agent_brain.schemas.base import Entity
from agent_brain.schemas.project_info import ProjectInfoRequest
from agent_brain.schemas.search import SearchQuery
from agent_brain.schemas import SyncReportResponse
...
async def run_doctor() -> None:
    ...
    console.print("[blue]Running Agent Brain doctor checks...[/blue]")
