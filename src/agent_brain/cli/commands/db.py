...
from agent_brain.services.initialization import reconcile_projects_with_config
            ...
            if path.exists():
                try:
                    ...
                    console.print(
                        ...
                        "Please close Claude Desktop or any other Agent Brain clients and try again."
                    )
                    raise typer.Exit(1)
