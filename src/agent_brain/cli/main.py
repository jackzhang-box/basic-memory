"""Main CLI entry point for agent-brain."""  # pragma: no cover

import sys
import warnings

from agent_brain.cli.app import app  # pragma: no cover
...
if not _version_only_invocation(sys.argv[1:]):
    ...
    from agent_brain.cli.commands import (  # noqa: F401  # pragma: no cover
        db,
        doctor,
        import_chatgpt,
