...
from agent_brain.schemas.schema import ValidationReport, InferenceReport, DriftReport
...
class TestSchemaClientValidate:
    ...
    async def test_validate_no_params(self, schema_client, monkeypatch):
        ...
        monkeypatch.setattr("agent_brain.mcp.clients.schema.call_post", mock_call_post)
...
class TestSchemaClientDiff:
    ...
    async def test_diff(self, schema_client, monkeypatch):
        ...
        monkeypatch.setattr("agent_brain.mcp.clients.schema.call_get", mock_call_get)
