...
from agent_brain.mcp.prompts.recent_activity import recent_activity_prompt
...
def test_prompt_context_with_file_path_no_permalink():
    ...
    from agent_brain.mcp.prompts.utils import (
        format_prompt_context,
        PromptContext,
        PromptContextItem,
    )
    from agent_brain.schemas.memory import EntitySummary
